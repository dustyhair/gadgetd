...
enum
{
	...
	PROP_DESC_BCDUSB = USBG_BCD_USB + 1,
	PROP_DESC_BDEVICECLASS = USBG_B_DEVICE_CLASS + 1,
	PROP_DESC_BDEVICESUBCLASS = USBG_B_DEVICE_SUB_CLASS + 1,
	PROP_DESC_BDEVICEPROTOCOL = USBG_B_DEVICE_PROTOCOL + 1,
	PROP_DESC_BMAXPACKETSIZE = USBG_B_MAX_PACKET_SIZE_0 + 1,
	PROP_DESC_IDVENDOR = USBG_ID_VENDOR + 1,
	PROP_DESC_IDPRODUCT = USBG_ID_PRODUCT + 1,
	PROP_DESC_BCDDEVICE = USBG_BCD_DEVICE + 1,
	PROP_GADGET_PTR
} prop_descriptors;
